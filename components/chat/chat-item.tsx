...
import { FileIcon, Ghost, Gitlab, ShieldAlert, ShieldCheck, Video } from "lucide-react";
...
const roleIconMap = {
    ...
    "ADMIN": <Ghost className="h-4 w-4 text-sky-500"/>
}
            ...
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
                    <div className="flex items-center gap-x-2">
                        ...
                        <span className="text-xs text-zinc-300">{timestamp}</span>
                    </div>
                    {isImage && (
                        <a 
                            href={fileUrl}
                            target="_blanck"
                            rel="noopener norefernce"
